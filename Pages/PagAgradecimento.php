...
<head>
 ...
 <!-- css -->
    ...
    <link rel="stylesheet" href="../Css/PagAgradecimento.css">
</head>
<body>
            ...
            <section class="agradecimento">
                ...
                <div class="agradecimento-box">
                    ...
                    <div class="pedido-info">
                        <p><strong>Número do Pedido:</strong> #2026001</p>
                        <p><strong>Status:</strong> Aguardando Separação</p>
                    </div>

                    <p class="mensagem">Em breve, você receberá mais informações sobre a entrega dos seus produtos.</p>
